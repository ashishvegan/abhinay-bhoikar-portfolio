...
const competencies = {
  ...
  dfs500: {
    ...
    summary:
      "A New York financial services regulation focused on cybersecurity governance and protection of information systems and nonpublic information.",
    meaning:
  ...
  useEffect(() => {
    const updateActiveSection = () => {
      ...
      sections.forEach((section) => {
        ...
        if (rect.top <= getSectionOffset(section.id) + 120) {
          current = section.id;
        }
      });
  ...
  return (
    <>
            ...
            <ul>
              ...
              <li>
                <a
                  ...
                  href="#experience" onClick={(e) => handleNavClick(e, "experience")}
                >
                  Experience
                </a>
              </li>
              <li>
                <a
                  ...
                  href="#education" onClick={(e) => handleNavClick(e, "education")}
                >
                  Education
                </a>
              </li>
              ...
              <li>
                <a
                  ...
                  href="#expertise" onClick={(e) => handleNavClick(e, "expertise")}
                >
                  Expertise
                </a>
              </li>
        ...
        <section id="hero" aria-labelledby="hero-title">
          ...
          <div className="hero-inner">
            ...
            <div className="hero-bottom">
              ...
              <a href="#about" onClick={(e) => handleNavClick(e, "about")} className="hero-cta">
              ...
              <div className="timeline-item reveal">
                <div className="timeline-content">
                  ...
                  <p className="timeline-desc">
                    ...
                    but I also lead awareness and adoption conversations around AI, from
                    governed retrieval and policy access to summarization, drafting, safe
                    prompting, and clearer understanding of how AI should be used inside a
      ...
      <footer>
        ...
        <div>Data · Governance · Responsible AI · New York · 2026</div>
      </footer>
