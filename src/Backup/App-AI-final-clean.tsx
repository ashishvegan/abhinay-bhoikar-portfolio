...
> = {
  ...
  bumble: {
    eyebrow: "Earlier Chapter",
    title: "Data Analyst",
    subtitle: "Bumble Tech Solutions · Wardha, India, India · Sep 2018 to Mar 2021",
    overview:
  ...
  ltech: {
    ...
    title: "Data Analyst",
    subtitle: "L tech Labs · Wardha, India, India · Apr 2017 to May 2018",
    overview:
...
const competencies = {
  ...
  genaiAssistants: {
    ...
    category: "Applied AI",
    summary: "Purpose built assistants configured for specific internal use cases inside a governed enterprise AI environment.",
    meaning: "GenAI assistants are not just open model access. They are pre configured tools designed for a defined task, output style, and user need through prompt structure, parameter tuning, and clear operating boundaries.",
    implementation: "I work within an internal enterprise chat interface connected to multiple models through API based access. I create assistants for email drafting, note summarization, translation, prompt generation, and governed knowledge support by shaping super prompts, tuning behavior, and aligning outputs to business safe usage.",
    visualTitle: "Assistant Lifecycle",
    visualSteps: ["Use Case", "Prompt", "Parameters", "Testing", "Guardrails", "Adoption"],
    bullets: [
      "Turns GenAI into a practical internal capability",
      "Connects AI use to defined business tasks",
      "Improves adoption through structure and disciplined setup"
    ],
    link: null
  },
  genaiGovernance: {
    ...
    summary: "The guardrails and control thinking required for safe GenAI adoption in regulated environments.",
    meaning: "Generative AI governance defines how models and assistants should be used, where they help, what their limits are, and how teams should handle output review, misuse risk, and data handling.",
    implementation: "I apply this through safe usage guidance, use case framing, prompt discipline, and reinforcement around what sensitive, private, restricted, or confidential data should never be entered into a model or assistant.",
    visualTitle: "Governance Layers",
    visualSteps: ["Use Case", "Data Boundaries", "Prompt Rules", "Review", "Controls", "Trust"],
    bullets: [
      "Supports responsible AI adoption in regulated environments",
      "Reduces prompt misuse and data exposure risk",
      "Connects AI behavior to enterprise governance expectations"
    ],
    link: null
  },
  aiLiteracy: {
    title: "AI Literacy & Best Practices",
    category: "Enablement",
    summary: "Education that helps teams understand AI, use it effectively, and avoid unsafe usage patterns.",
    meaning: "AI literacy means helping teams understand what AI, GenAI, assistants, and agentic AI are, how they behave, where they add value, where they fail, and how responsible usage should work in practice.",
    implementation: "I educate teams on AI awareness, prompt discipline, output review, assistant selection, and safe usage best practices, including what sensitive, private, and restricted information should never be shared with a model.",
    visualTitle: "Literacy Flow",
    visualSteps: ["Awareness", "Use Cases", "Best Practices", "Data Safety", "Review", "Confidence"],
    bullets: [
      "Builds confidence through informed usage",
      "Improves output quality through better prompting",
      "Helps teams understand what data should never be provided to AI"
    ],
    link: null
  },
  agenticAI: {
    title: "Agentic AI Readiness",
    category: "Next Direction",
    summary: "Preparing teams and governance models for AI systems that act across multiple steps rather than answering a single prompt.",
    meaning: "Agentic AI raises the bar because the system can reason through tasks, sequence actions, and operate with more autonomy. That creates new expectations around oversight, escalation, and control.",
    implementation: "I help teams understand what agentic AI is, how it differs from GenAI assistants, and why stronger literacy, usage boundaries, and governance readiness are required before moving toward more autonomous AI patterns.",
    visualTitle: "Readiness Path",
    visualSteps: ["Literacy", "Use Cases", "Controls", "Oversight", "Escalation", "Readiness"],
    bullets: [
      "Prepares the organization for the next stage of AI adoption",
      "Extends governance beyond prompt based interaction",
      "Frames autonomy as a control and accountability question"
    ],
    link: null
  }
} as const;
...
const skillDetails = {
  governanceAi: {
    ...
    intro:
      "I build the operational foundations that make data trustworthy, governance real, and enterprise controls measurable.",
    meaning:
      "Data quality and governance are not policy exercises. They are engineering and operating discipline built from critical data ownership, control logic, issue accountability, and leadership routines that hold up in audits and committees.",
    application:
      "I lead data quality programs, governance operating models, critical data element management, issue management, and scorecard frameworks across risk, finance, retail, and commercial domains.",
    methods: [
  ...
  aiPractice: {
    title: "GenAI, Assistants, and Responsible AI",
    intro:
      "I work where practical AI usage, assistant design, and governance discipline come together.",
    meaning:
      "This work is about more than model access. It is about shaping assistants for specific tasks, tuning their behavior to the scenario, and helping teams understand how to use AI well inside a regulated environment.",
    application:
      "Using an internal enterprise chat platform connected to multiple models through API based access, I design purpose built assistants for drafting, summarization, translation, and prompt support. I also stay hands on with Claude, ChatGPT, Perplexity, and Gemini to understand how models reason and generate, and I educate teams on GenAI, agentic AI, and what sensitive or restricted data should never be shared with a model.",
    methods: [
      "Assistant design through super prompts and defined use cases",
      "Temperature and top p tuning based on factual versus creative output needs",
      "AI literacy and best practice education for teams",
      "Responsible adoption aligned to governance and data sensitivity",
      "Claude, ChatGPT, Perplexity, and Gemini for hands on model understanding"
    ]
  }
} as const;
          ...
          <div className="section-inner">
            <div className="core-chips">
              {[
                ...
                ["dama", "DAMA"],
                  ["genaiAssistants", "GenAI Assistants"],
                  ["genaiGovernance", "Generative AI Governance"],
                  ["aiLiteracy", "AI Literacy & Best Practices"],
                  ["agenticAI", "Agentic AI Readiness"]
              ].map(([key, label]) => (
                <button
                  key={key}
                  type="button"
            ...
            <div className="timeline">
              ...
              <div className="timeline-item reveal">
                <div className="timeline-content">
                  <div className="timeline-year">2025 to Present</div>
                  <div className="timeline-place">New York, NY</div>
                  <div className="timeline-role">Natixis North America LLC</div>
                  <p className="timeline-desc">
                    Today the work is broader. I still lead data quality and governance,
                    but I also design GenAI assistants for specific use cases, support governed
                    internal AI adoption, and educate teams on GenAI, agentic AI, safe prompting,
                    and what sensitive, private, or restricted data should never be entered into a model.
                  </p>
                </div>
              ...
              <div className="timeline-item reveal">
                ...
                <div className="timeline-content">
                  <div className="timeline-year">2021 to 2025</div>
                  <div className="timeline-place">New York, NY</div>
              ...
              <div className="timeline-item reveal">
                ...
                <div className="timeline-content">
                  <div className="timeline-year">2018 to 2021</div>
              ...
              <div className="timeline-item reveal">
                <div className="timeline-content">
                  <div className="timeline-year">2017 to 2018</div>
                  <div className="timeline-place">Wardha, India</div>
        ...
        <section id="expertise" aria-labelledby="expertise-title">
          <div className="section-inner">
            ...
            <div className="skills-grid">
              {(
                [
                  ["governanceAi", "01", "Data Quality and Governance", "I build disciplined data quality foundations, governance operating models, and control frameworks that make accountability measurable and enterprise trust real."],
                  ...
                  ["aiPractice", "03", "GenAI, Assistants, and Responsible AI", "I design GenAI assistants for specific enterprise use cases, guide responsible adoption inside regulated environments, and help teams understand AI, GenAI, and agentic AI with the literacy and discipline those tools require."]
                ] as const
          ...
          <div className="section-inner">
            ...
            <div className="philosophy-grid">
              ...
              <div className="principles">
                ...
                <div className="principle">
                  <div className="principle-title">AI needs literacy before scale</div>
                  <p className="principle-text">
                    Before organizations automate more, teams need to understand what AI is,
                    what it is not, where it helps, and where controls and judgment matter
                    most.
                  </p>
                </div>
                <div className="principle">
                  ...
                  <p className="principle-text">
                    The best AI adoption improves retrieval, drafting, summarization, and
                    decision support without weakening classification, confidentiality, or
                    operating discipline.
                  </p>
                </div>
                <div className="principle">
                  <div className="principle-title">Assistants need architecture, not just access</div>
                  <p className="principle-text">
                    Giving teams GenAI access without a defined prompt structure, tuned parameters,
                    and clear data boundaries is not adoption. Good assistant design is a governance
                    decision.
                  </p>
                </div>
              </div>
            ...
            <div className="now-next-grid">
              <div className="now-next-card">
                ...
                <ul className="now-next-list">
                  ...
                  <li>Design assistants for drafting, summarization, translation, and prompt support inside governed internal AI workflows</li>
                  <li>Educate teams on GenAI best practices and what data should never be shared with a model</li>
                </ul>
              </div>
              ...
              <div className="now-next-card">
                ...
                <ul className="now-next-list">
                  ...
                  <li>Preparing governance frameworks for agentic AI and multi step autonomous workflows</li>
                  <li>Extending data classification and control discipline into assistant and LLM workflows</li>
                  <li>Building AI literacy programs that evolve from GenAI understanding into agentic AI readiness</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="drawer-header">
              <div>
                ...
                {"subtitle" in drawerData && drawerData.subtitle ? (
                  <p className="drawer-subtitle">{drawerData.subtitle}</p>
                ) : null}
              </div>
              <button
                type="button"
